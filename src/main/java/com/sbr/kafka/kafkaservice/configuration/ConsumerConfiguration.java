package com.sbr.kafka.kafkaservice.configuration;

import com.sbr.kafka.kafkaservice.model.Request;
import com.sbr.kafka.kafkaservice.utils.MessageDeserializer;
...
public class ConsumerConfiguration {
    ...
    private static final String TOPIC = "client-request";
    ...
    protected ReceiverOptions<String, Request> kafkaReceiverOptions() {
        ...
        return options.subscription(Collections.singleton("producer-request"))
